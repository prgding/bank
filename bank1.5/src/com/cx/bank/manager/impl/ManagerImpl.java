...
public class ManagerImpl implements ManagerInterface {
    ...
    public void transfer(String toName, BigDecimal transMoney) throws IOException, AccountOverDrawnException {
        ...
        if (fromMoney.compareTo(BigDecimal.ZERO) < 0) {
            ...
            props.setProperty("money", fromMoney.toString());
            String msg = this.getUserBean().getUsername() + " 的用户信息";
            ...
            props.setProperty("money", toMoney.toString());
//            System.out.println("对方账户余额 = " + toMoney);
            msg = toName + " 的用户信息";
            props.store(new FileOutputStream("./userInfo/" + toName + ".properties"), msg);
